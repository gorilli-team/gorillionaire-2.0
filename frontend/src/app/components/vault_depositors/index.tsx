...
const VaultDepositors: React.FC = () => {
  const depositors: Depositor[] = [
    { rank: 1, investor: "0x123...abcd", percentage: "10.00%", value: "$5,000", image: "/gorillionaire.jpg" },
    { rank: 2, investor: "0x456...efgh", percentage: "5.00%", value: "$2,500", image: "/gorillionaire.jpg" },
  ];
